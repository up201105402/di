...
<template>
    <div class="border-1 surface-border border-round m-2 text-center py-5 px-3">
        ...
        <div>
            <h4 v-if="queryCount > 1" class="mb-1">Query {{ query.HumanFeedbackQuery.QueryID + 1 }}/{{ queryCount }}</h4>
            <h4 v-else="queryCount == 1" class="mb-1">Query {{ queryCount }}/{{ queryCount }}</h4>
