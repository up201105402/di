...
export const stepConfigGroupChildren = (trained) => {
    return [
        {
            $formkit: 'select',
            name: 'trainedName',
            options: [trained.name],
            label: t('pages.pipelines.edit.dialog.stepConfig.trained'),
            value: trained.name,
        },
        {
            $formkit: 'checkbox',
...
export const trainedForm = function (model) {
