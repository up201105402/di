...
export const stepConfigGroupChildren = (dataset) => {
    return [
        {
            $formkit: 'select',
            name: 'datasetName',
            options: [dataset.name],
            label: t('pages.pipelines.edit.dialog.stepConfig.datasetName'),
            value: dataset.name,
        },
        {
            $formkit: 'text',
...
export const datasetForm = function (dataset) {
        ...
        const formSchema = [
            {
                ...
                children: [
                    stepTabs,
                    getFormBody(nameAndTypeGroupChildren, stepConfigGroupChildren(dataset)),
