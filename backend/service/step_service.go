...
func initStepTypeRegistry() map[string]reflect.Type {
	...
	stepTypes := []interface{}{steps.CheckoutRepo{}, steps.ShellScript{}, steps.Dataset{}, steps.Trainer{}, steps.Trained{}, steps.CustomPyTorchModel{}, steps.HumanFeedbackNN{}, steps.CustomHITL{}, steps.ScikitTestingDataset{}, steps.ScikitTrainingDataset{}}
